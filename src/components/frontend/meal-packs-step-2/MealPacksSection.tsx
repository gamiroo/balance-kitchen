        ...
        <div className={styles.contentContainer}>
          ...
          <div className={styles.textContent}>
            ...
            <p className={styles.sectionDescription}>
              Start by selecting your meal size, then customize with optional
              subscription services. Our tiered customization options build upon
              each other to give you exactly what you need.
            </p>
              ...
              <div className={styles.tabContainer}>
                ...
                <div className={styles.tabContent}>
                  {activeStep === 0 && (
                    <div className={styles.stepContent}>
                      <h3 className={styles.modalSubheading}>
                        Step 1: Choose Your Meal Size
                      </h3>
                      <p className={styles.modalDescription}>
                        Start by selecting from our two perfectly portioned
                        options:
                      </p>
                        ...
                        <div className={styles.modalPlan}>
                          ...
                          <div className={styles.modalPlanHalf}>
                            <div className={styles.modalPlanContent}>
                              <h4 className={styles.modalPlanTitle}>
                                Balance Lean
                              </h4>
                              <p className={styles.modalPlanDetails}>
                                120G PROTEIN, 100G CARB, 80G VEG
                              </p>
                        ...
                        <div className={styles.modalPlan}>
                          ...
                          <div className={styles.modalPlanHalf}>
                            <div className={styles.modalPlanContent}>
                              ...
                              <p className={styles.modalPlanDetails}>
                                160G PROTEIN, 160G CARB, 110G VEG
                              </p>
                              <ul className={styles.modalPlanPricing}>
                  ...
                  {activeStep === 1 && (
                    <div className={styles.stepContent}>
                      <h3 className={styles.modalSubheading}>
                        Step 2: Customization Subscriptions
                      </h3>
                      <p className={styles.modalDescription}>
                        Have specific dietary needs or fitness goals? We
                        specialise in tailored meals designed just for you. From
                        low-histamine diets to keto, low-fiber, or
                        allergy-friendly options, we&apos;ve got you covered.
                      </p>
                      ...
                      <div className={styles.modalTierContainer}>
                        ...
                        <div className={styles.modalTier}>
                          ...
                          <p className={styles.modalTierIncludes}>
                        ...
                        <div className={styles.modalTier}>
                          ...
                          <p className={styles.modalTierIncludes}>
                            (Includes everything from Tier 1 &amp; 2)
                          </p>
                          <ul className={styles.modalTierFeatures}>
                  ...
                  {activeStep === 2 && (
                    <div className={styles.stepContent}>
                      ...
                      <p className={styles.modalDescription}>
                        After selecting your meal size and customization tier,
                        you must choose a delivery or pick-up option:
                      </p>
                        ...
                        <div className={styles.deliveryOption}>
                          ...
                          <div className={styles.optionContent}>
                            ...
                            <p className={styles.optionDescription}>
                              Convenient doorstep delivery with flexible
                              scheduling. Choose from weekly, bi-weekly, or
                      ...
                      <p className={styles.modalDescription}>
                        Enquire now to see if we can help you achieve your
                        dietary goals!
                      </p>
                    </div>
                  )}
                  ...
                  {activeStep === 3 && (
                    <div className={styles.stepContent}>
                      ...
                      <p className={styles.modalDescription}>
                        Review your selected meal plan before proceeding to
                        checkout.
                      </p>
