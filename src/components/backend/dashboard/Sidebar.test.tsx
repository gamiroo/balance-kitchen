...
describe('DashboardSidebar', () => {
  ...
  beforeEach(() => {
    ...
    (usePathname as jest.Mock).mockReturnValue('/backend/dashboard');
  ...
  it('should render sub-menu items when section is expanded', () => {
    (usePathname as jest.Mock).mockReturnValue('/backend/dashboard/history/orders');
    render(<DashboardSidebar />);
  ...
  it('should highlight active menu item based on current path', () => {
    (usePathname as jest.Mock).mockReturnValue('/backend/dashboard/orders');
    render(<DashboardSidebar />);
